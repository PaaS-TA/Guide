...
- 운영 환경 설치
  ...
  - 파스타 플랫폼 수동 설치
    ...
    - [파스타 수동 설치(AWS, OpenStack, VMWare vSphere, GCP, MS Azure)](./install-guide/paasta/PAAS-TA_CORE_INSTALL_GUIDE_V5.0.md)
...
- [Jenkins 서비스](./use-guide/tools/PAAS-TA_JENKINS_SERVICE_USER_GUIDE.md)
## 개발 언어별 애플리케이션 가이드
