...
- 운영 환경 설치
  ...
  - PaaS-TA 플랫폼 수동 설치
    - [BOSH 설치(AWS)](./install-guide/bosh/PAAS-TA_BOSH2_INSTALL_GUIDE_V5.0.md)
    - [PaaS-TA 설치(AWS)](./install-guide/paasta/PAAS-TA_CORE_INSTALL_GUIDE_V5.0.md)
