...
- ### PaaS-TA Monitoring 설치 순서<br>(Monitoring을 사용할 경우 BOSH와 PaaS-TA를 설치할 때 Monitoring에 관한 Option을 넣어줘야 한다)
  - 1\. [Monitoring 옵션을 포함한 BOSH 설치](../../install-guide/bosh/PAAS-TA_BOSH2_INSTALL_GUIDE_V5.0.md)
  - 2\. [Monitoring 옵션을 포함한 PaaS-TA 5.1 설치](../../install-guide/paasta/PAAS-TA_CORE_INSTALL_GUIDE_V5.0.md)
