...
> $ vi ~/workspace/paasta-5.5.0/deployment/service-deployment/source-control-service/vars.yml
...
> $ vi ~/workspace/paasta-5.5.0/deployment/service-deployment/source-control-service/deploy.sh
...
- 서비스를 설치한다.  
```
$ cd ~/workspace/paasta-5.5.0/deployment/service-deployment/source-control-service  
$ sh ./deploy.sh  
```  
