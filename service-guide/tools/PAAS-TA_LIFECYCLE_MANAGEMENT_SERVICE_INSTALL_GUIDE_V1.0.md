...
> $ vi ~/workspace/paasta-5.5.0/deployment/service-deployment/lifecycle-service/vars.yml
...
- 서비스를 설치한다.  
```
$ cd ~/workspace/paasta-5.5.0/deployment/service-deployment/lifecycle-service
$ sh ./deploy.sh  
```  
