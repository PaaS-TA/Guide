...
> $ vi ~/workspace/paasta-5.5.0/deployment/service-deployment/logging-service/vars.yml
...
> $ vi ~/workspace/paasta-5.5.0/deployment/service-deployment/logging-service/deploy.sh
...
- 서비스를 설치한다.  
```
$ cd ~/workspace/paasta-5.5.0/deployment/service-deployment/logging-service
$ sh ./deploy.sh  
```  
