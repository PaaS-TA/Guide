...
3. [PaaS-TA 5.0 설치](#108)
    ...
    * [PaaS-TA 설치](#1030)
    * [PaaS-TA 로그인](#1031)
    * [통합 Monitoring을 적용한 PaaS-TA 5.0 설치](#1032)
...
파스타 다운로드 URL에서 [PaaS-TA Stemcell] 파일을 내려받아 ${HOME}/workspace/paasta-5.0/stemcell 이하 디렉터리에 압축을 푼다. 압출을 풀면 아래 그림과 같이 ${HOME}/workspace/paasta-5.0/stemcell/paasta 디렉터리가 생성되며 릴리즈 파일(tgz)이 존재한다.
...
### <div id='1032'/> * 통합 Monitoring을 적용한 PaaS-TA 5.0 설치
- [통합 Monitoring을 적용한 PaaS-TA 5.0 설치](https://github.com/PaaS-TA)
