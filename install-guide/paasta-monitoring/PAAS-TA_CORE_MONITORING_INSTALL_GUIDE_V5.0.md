...
로컬 파일을 사용할 경우 PaaS-TA 사이트에서 [PaaS-TA Stemcell](http://45.248.73.44/index.php/s/PnxxbkmLiLpXdBD) 파일을 내려받아 ${HOME}/workspace/paasta-5.0/stemcell 이하 디렉터리에 압축을 푼다.   
